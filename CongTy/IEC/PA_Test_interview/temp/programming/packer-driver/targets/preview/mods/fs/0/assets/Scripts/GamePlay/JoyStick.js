    ...
    execute: function () {
      ...
      _export("JoyStick", JoyStick = (_dec = ccclass('JoyStick'), _dec2 = property(_crd && BlackHole === void 0 ? (_reportPossibleCrUseOfBlackHole({
        ...
        touchMove(event) {
          ...
          this.currentTouchPos = this.getLocalTouchPos(event);
          var distance = this.currentTouchPos.clone().subtract(this.max_r.position),
        ...
        getRadian() {
          var result = null;
          var directionVector;
          var max_r_pos = this.max_r.getPosition();
          var newPos = new Vec2(max_r_pos.x, max_r_pos.y);
