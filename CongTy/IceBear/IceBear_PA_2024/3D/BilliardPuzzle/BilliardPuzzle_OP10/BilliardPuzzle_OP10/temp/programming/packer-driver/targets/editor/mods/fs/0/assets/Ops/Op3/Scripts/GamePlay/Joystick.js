System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Camera, Component, screen, Node, Quat, Vec2, Vec3, Global, SoundManager, Constants, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _temp, _crd, ccclass, property, Joystick;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "8459e6Po3RJSbHoCFrY7eZn", "Joystick", undefined);
      ...
      _export("Joystick", Joystick = (_dec = ccclass('Joystick'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Camera), _dec(_class = (_class2 = (_temp = class Joystick extends Component {
        constructor(...args) {
          super(...args);
