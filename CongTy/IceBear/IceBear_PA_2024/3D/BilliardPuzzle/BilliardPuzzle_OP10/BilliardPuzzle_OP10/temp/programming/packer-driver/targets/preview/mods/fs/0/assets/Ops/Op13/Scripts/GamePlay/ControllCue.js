System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Node, _decorator, Component, misc, EventManager, Global, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _temp, _crd, ccclass, property, ControllCue;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "47206F0CKFH1Ywmbvn4fPDC", "ControllCue", undefined);
      ...
      _export("default", ControllCue = (_dec = ccclass('ControllCue'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = (_temp = class ControllCue extends Component {
        ...
        onMouseMove(event) {
          ...
          var delta = event.getLocationY() - this.startY;
          delta *= 1.1;
          ...
          var newY = this.startYCueUIPos + delta;
          newY = misc.clampf(newY, -418, -10.046);
          this.cueUI.setPosition(0, newY, 0);
          var newX = this.startXCuePos + delta * 0.00037994386;
