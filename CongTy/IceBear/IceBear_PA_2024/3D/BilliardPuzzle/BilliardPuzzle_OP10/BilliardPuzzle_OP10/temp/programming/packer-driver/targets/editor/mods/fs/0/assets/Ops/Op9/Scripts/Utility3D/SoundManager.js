System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, AudioClip, AudioSource, Singleton, Constants, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _temp, _crd, ccclass, property, SoundManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "be6a6ClNoFA0b2XjqVwmaUu", "SoundManager", undefined);
      ...
      _export("SoundManager", SoundManager = (_dec = ccclass('SoundManager'), _dec2 = property(AudioSource), _dec3 = property(AudioSource), _dec4 = property(AudioClip), _dec5 = property(AudioSource), _dec6 = property(AudioSource), _dec7 = property(AudioClip), _dec8 = property(AudioSource), _dec(_class = (_class2 = (_temp = class SoundManager extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        error: Error()
      }), Singleton) : Singleton) {
        constructor() {
          super();
          ...
          _initializerDefineProperty(this, "winSound", _descriptor7, this);
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "winSound", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
