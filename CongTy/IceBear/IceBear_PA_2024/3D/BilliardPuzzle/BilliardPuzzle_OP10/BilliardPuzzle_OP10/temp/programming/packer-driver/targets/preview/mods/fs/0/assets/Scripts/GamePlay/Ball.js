System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "eff1cmJrpVOtJ+2y37FZ9M/", "Ball", undefined);
          ...
          if (event.type === 'onTriggerEnter') {
            ...
            if (otherTrigger.getGroup() === 8) {
              ...
              (_crd && SoundManager === void 0 ? (_reportPossibleCrUseOfSoundManager({
                ...
                error: Error()
              }), SoundManager) : SoundManager).PlaySound("winSound");
        ...
        RollIOnHole(hole) {
          ...
          tween(this.node).to(0.08, {
            ...
            (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
              ...
              error: Error()
            }), GameManager) : GameManager).activeFx(hole);
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              error: Error()
