System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, AudioSource, Singleton, IronSource, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _temp, _crd, ccclass, property, SoundController;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("SoundController", SoundController = (_dec = ccclass('SoundController'), _dec2 = property(AudioSource), _dec3 = property(AudioSource), _dec4 = property(AudioSource), _dec5 = property(AudioSource), _dec6 = property(AudioSource), _dec7 = property(AudioSource), _dec(_class = (_class2 = (_temp = class SoundController extends (_crd && Singleton === void 0 ? (_reportPossibleCrUseOfSingleton({
        error: Error()
      }), Singleton) : Singleton) {
        constructor() {
          super();
          ...
          _initializerDefineProperty(this, "bangSound", _descriptor2, this);

          _initializerDefineProperty(this, "mergeSound", _descriptor3, this);
        ...
        PlaySound(stringAudioName) {
          if (!(_crd && IronSource === void 0 ? (_reportPossibleCrUseOfIronSource({
            error: Error()
          }), IronSource) : IronSource).SoundState) return;
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "bangSound", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "mergeSound", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
