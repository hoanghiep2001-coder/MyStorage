  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIGameController", UIGameController = (_dec = ccclass('UIGameController'), _dec2 = property(_crd && GameController === void 0 ? (_reportPossibleCrUseOfGameController({
        ...
        registerEvent() {
          var hideMask = this.CTA.getChildByName("HideMask");
          var btn = this.CTA.getChildByName("btn"); // applovin & mtg
        ...
        activeTweenForBtnCTA() {
          var btn = this.CTA.getChildByName("btn");
        ...
        showCTATextContent() {
          ...
          var label = this.CTA.getChildByName("btn").getChildByName("Label").getComponent(Label);
