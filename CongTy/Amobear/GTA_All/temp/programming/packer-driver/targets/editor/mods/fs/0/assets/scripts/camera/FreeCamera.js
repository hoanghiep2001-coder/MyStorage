System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, game, Input, input, Quat, Vec2, Vec3, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _temp, _crd, ccclass, property, v2_1, v2_2, v3_1, qt_1, forward, right, FreeCamera;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("FreeCamera", FreeCamera = (_dec = ccclass('FreeCamera'), _dec2 = property({
        slide: true,
        range: [0.05, 0.5, 0.01]
      }), _dec(_class = (_class2 = (_temp = class FreeCamera extends Component {
        constructor(...args) {
          super(...args);
          ...
          _defineProperty(this, "_eulerP", new Vec3());

          _defineProperty(this, "keys", []);

          _defineProperty(this, "moveDir", new Vec3());
        }
        ...
        onLoad() {
          ...
          Vec3.copy(this._eulerP, this.node.eulerAngles); // input.on(Input.EventType.KEY_DOWN, this.onKeyDown, this);
        ...
        onDestroy() {
          ...
          input.off(Input.EventType.TOUCH_END, this.onTouchEnd, this); // input.off(Input.EventType.KEY_DOWN, this.onKeyDown, this);
