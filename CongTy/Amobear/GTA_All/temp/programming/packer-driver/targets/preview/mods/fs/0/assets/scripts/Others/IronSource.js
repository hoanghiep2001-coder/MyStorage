System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, SoundController, IronSource, _crd, handleIronSourcePlaySound, handleMuteSoundIronSource;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f47fernEbxEK70OPjy6vQeG", "IronSource", undefined);
      ...
      handleIronSourcePlaySound = () => {
        ...
        if (IronSource.SoundState) {
          (_crd && SoundController === void 0 ? (_reportPossibleCrUseOfSoundController({
            ...
            error: Error()
          }), SoundController) : SoundController).playSound("bgSound");
        }
