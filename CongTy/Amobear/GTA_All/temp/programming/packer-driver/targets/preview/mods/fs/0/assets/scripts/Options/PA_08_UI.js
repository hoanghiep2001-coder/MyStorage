System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, easing, Node, tween, GameInfo, SoundController, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _temp, _crd, ccclass, property, PA_08_UI;
        ...
        activeCinematic() {
          ...
          this.scheduleOnce(() => {
            tween(this.policeCars[0]).to(0.5, {
              ...
              var vfx_fireBall = this.policeCars[0].getChildByName("FireBall");
            ...
            tween(this.policeCars[1]).to(0.5, {
              ...
              var vfx_fireBall = this.policeCars[1].getChildByName("FireBall");
              vfx_fireBall.active = true;
              (_crd && SoundController === void 0 ? (_reportPossibleCrUseOfSoundController({
                error: Error()
              }), SoundController) : SoundController).Instance(_crd && SoundController === void 0 ? (_reportPossibleCrUseOfSoundController({
