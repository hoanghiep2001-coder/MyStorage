System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Node, screen, GameInfo, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _temp, _crd, ccclass, property, PA_10_Responsive;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "276c3zl6bJGmIjChcA7F9Aw", "PA_10_Responsive", undefined);
      ...
      _export("PA_10_Responsive", PA_10_Responsive = (_dec = ccclass('PA_10_Responsive'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = (_temp = class PA_10_Responsive extends Component {
        constructor() {
          super(...arguments);
        ...
        setHorizontalForTablet() {
          ...
          this.CTA.setScale(2.2, 2.2, 2.2);
          this.Tut.setPosition(0, 0, 0);
          this.Tut.setScale(1, 1, 1); // if (screen.windowSize.width / screen.windowSize.height < 0.7) {
...
//# sourceMappingURL=PA_10_Responsive.js.map