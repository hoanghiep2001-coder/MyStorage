...
@ccclass('PA_11_GameController')
export class PA_11_GameController extends Component {
    ...
    protected start(): void {
        ...
        this.schedule(() => {
            if(GameInfo.GTA_PA_11.currentEnemyKilled >= 2) return;
    ...
    protected update(dt: number): void {
        if (GameInfo.GTA_PA_11.currentEnemyKilled >= 2 && !GameInfo.GTA_PA_11.isShowInstallPopup) {
