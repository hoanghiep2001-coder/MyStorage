  ...
  return {
    ...
    execute: function () {
      ...
      _export("PA_30_CameraController", PA_30_CameraController = (_dec = ccclass('PA_30_CameraController'), _dec2 = property(_crd && TimeCount === void 0 ? (_reportPossibleCrUseOfTimeCount({
        ...
        handleTweenToTable() {
          var tablePos = new Vec3(0.338, 9.477, -0.31),
        ...
        handleGoToBox(boxWorldPos) {
          var newEuler = new Vec3(-45, -5, 0);
          var cameraComp = this.getComponent(Camera);
          var currentFov = cameraComp.fov;
        ...
        handleLookAt() {
          ...
          var cameraPos = new Vec3(this._targetPos.x, this._targetPos.y + this.followHeight, this._targetPos.z + this.followDistance); // Di chuyển camera đến vị trí mới
        ...
        showFullBox() {
          ...
          var needleTarget = this.target.getPosition();
          ...
          var cameraComp = this.getComponent(Camera);
          var targetWorldPos = this.boxToTarget.worldPosition;
          var newWorldPos = new Vec3(targetWorldPos.x, targetWorldPos.y + 3, targetWorldPos.z);
          var newEuler = new Vec3(-90, -5, 0);
          tween(cameraComp).to(0.3, {
            fov: this.ORIGINAL_FOV
          }, {
            easing: easing.smooth
