        ...
        getRaycastResult(touchPos) {
          ...
          if (PhysicsSystem.instance.raycastClosest(ray, mask, maxDistance, queryTrigger)) {
            ...
            if (collider.node.name.includes("Box")) {
              ...
              const boxBehavior = collider.getComponent(_crd && BoxBehavior === void 0 ? (_reportPossibleCrUseOfBoxBehavior({
                error: Error()
              }), BoxBehavior) : BoxBehavior);
              const cameraController = this.Cam_3D.getComponent(_crd && PA_30_CameraController === void 0 ? (_reportPossibleCrUseOfPA_30_CameraController({
                error: Error()
