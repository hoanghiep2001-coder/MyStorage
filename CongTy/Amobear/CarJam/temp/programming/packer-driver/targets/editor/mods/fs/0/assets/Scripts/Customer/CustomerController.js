    ...
    execute: function () {
      ...
      _export("CustomerController", CustomerController = (_dec = ccclass('CustomerController'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property([Node]), _dec(_class = (_class2 = (_temp = class CustomerController extends Component {
        ...
        createCustomer(startPos, queueIndex) {
          ...
          const customerBehavior = customerNode.getComponent(_crd && CustomerBehavior === void 0 ? (_reportPossibleCrUseOfCustomerBehavior({
            error: Error()
          ...
          if ((_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
            ...
            return math.randomRangeInt(0, 7); // use for forced user lose
              ...
              return math.randomRangeInt(0, 8);
                ...
                let newArrColorID = [7, 2, 5, 1, 0]; // forced player lose;
        ...
        moveCustomerToNext(customer, currentIndex) {
          const nextIndex = currentIndex + 1; // // Kiểm tra nếu còn vị trí tiếp theo

          const nextPosition = (_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
            error: Error()
          ...
          if (nextPosition && !nextPosition.isReady) {
            tween(customer).to(0.1, {
              ...
              const customerBehavior = customer.getComponent(_crd && CustomerBehavior === void 0 ? (_reportPossibleCrUseOfCustomerBehavior({
                error: Error()
              }), CustomerBehavior) : CustomerBehavior);
        ...
        update(dt) {
          ...
          if (this.timer >= this.interval) {
            this.timer = 0;
            let firstCumtomer = (_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
              error: Error()
            ...
            let result = (_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
              error: Error()
            ...
            if (result) {
              ...
              for (let index = 0; index < (_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
                error: Error()
              }), GameInfo) : GameInfo).customerQueue.length; index++) {
                const queue = (_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
                  error: Error()
