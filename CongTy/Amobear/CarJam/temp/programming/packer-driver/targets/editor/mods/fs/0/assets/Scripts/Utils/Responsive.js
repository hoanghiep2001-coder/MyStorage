System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, Component, Vec3, _decorator, log, screen, UIGameController, GameInfo, _dec, _class, _class2, _descriptor, _temp, _crd, ccclass, property, Responsive;
      ...
      _export("default", Responsive = (_dec = property(_crd && UIGameController === void 0 ? (_reportPossibleCrUseOfUIGameController({
        ...
        setHorizontalForIpX() {
          ...
          if (screen.windowSize.height / screen.windowSize.width < 0.47) {
            ...
            (_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
              error: Error()
            }), GameInfo) : GameInfo).queueLabelCalPosX = 16;
            (_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
              error: Error()
            }), GameInfo) : GameInfo).queueLabelCalPosY = 158;
        ...
        setHorizontalForTablet() {
          ...
          this.UIGameController.Tut_1.setPosition(0, -30, 0);
          this.UIGameController.QueueLabel.node.scale = new Vec3(0.42, 0.42, 0.42); // if (screen.windowSize.width / screen.windowSize.height < 0.7) {
        ...
        setIphoneX() {
          ...
          (_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
            error: Error()
          }), GameInfo) : GameInfo).queueLabelCalPosX = 24;
          (_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
            error: Error()
          }), GameInfo) : GameInfo).queueLabelCalPosY = 222;
        ...
        setMobile() {
          ...
          if (height / width > 1.5) {
            if (width / height >= 0.6 && width / height < 0.62) {
              ...
              (_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
                error: Error()
              }), GameInfo) : GameInfo).queueLabelCalPosX = 19;
              (_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
                error: Error()
              }), GameInfo) : GameInfo).queueLabelCalPosY = 175;
            ...
            (_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
              error: Error()
            }), GameInfo) : GameInfo).queueLabelCalPosY = 183;
            this.UIGameController.QueueLabel.node.scale = new Vec3(0.5, 0.5, 0.5);
          } else {
            this.UIGameController.Tut_1.setPosition(0, -30, 0);
            (_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
              error: Error()
            }), GameInfo) : GameInfo).queueLabelCalPosX = 18;
            (_crd && GameInfo === void 0 ? (_reportPossibleCrUseOfGameInfo({
              error: Error()
            }), GameInfo) : GameInfo).queueLabelCalPosY = 158;
            this.UIGameController.QueueLabel.node.scale = new Vec3(0.48, 0.48, 0.48);
