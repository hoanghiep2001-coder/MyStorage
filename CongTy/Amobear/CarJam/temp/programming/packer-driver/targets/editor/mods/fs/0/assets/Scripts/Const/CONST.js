  ...
  return {
    ...
    execute: function () {
      ...
      (function (SoundTrack) {
        ...
        SoundTrack["carExit"] = "carExit";
        SoundTrack["carMoveToPlace"] = "carMoveToPlace";
        SoundTrack["Happy"] = "Happy";
        SoundTrack["Impact"] = "Impact";
        SoundTrack["LoadCustomer"] = "LoadCustomer";
        SoundTrack["unlockHiddenCarSound"] = "unlockHiddenCarSound";
