    ...
    execute: function () {
      ...
      _export("CarHidden", CarHidden = (_dec = ccclass('CarHidden'), _dec2 = property([_crd && CarBehavior === void 0 ? (_reportPossibleCrUseOfCarBehavior({
        ...
        transformRandomCarColor() {
          ...
          this.bounceAnim();
          var colorCarArr = this.getCarColorArr();
          var carColor = this.getRandomString(colorCarArr);
          var carSkinComp = this.getComponent(_crd && CarSkin === void 0 ? (_reportPossibleCrUseOfCarSkin({
            error: Error()
          }), CarSkin) : CarSkin);
          ...
          var carColorNode = this.node.getChildByName("base").getChildByName(carColor);
